...
pub use nostr_identity::{
    ...
    KIND_NOSTR_IDENTITY_ROSTER_OP, NostrIdentityCapabilities, NostrIdentityDeviceApprovalBootstrap,
    NostrIdentityDeviceApprovalRequest, NostrIdentityError, NostrIdentityFacet, NostrIdentityId,
    NostrIdentityKeyPurpose, NostrIdentityRosterOp, SignedNostrIdentityRosterOp,
    ...
    parse_nostr_identity_device_approval_bootstrap, parse_nostr_identity_roster_op_event,
    project_nostr_identity_roster,
};
use nostr_sdk::prelude::{Event, Keys, PublicKey};
...
/// scan/link request helpers without replacing the accepted legacy roster.
