...
pub use nostr_identity::{
    ...
    NOSTR_IDENTITY_DEVICE_APPROVAL_APPLIED_ACK_TYPE, NOSTR_IDENTITY_DEVICE_APPROVAL_RECEIPT_SCHEMA,
    NOSTR_IDENTITY_DEVICE_APPROVAL_RECEIPT_TYPE, NostrIdentityCapabilities,
    NostrIdentityDeviceApprovalAppliedAck, NostrIdentityDeviceApprovalBootstrap,
