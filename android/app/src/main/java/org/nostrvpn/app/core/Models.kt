...
data class AppState(
    ...
    val internetSource: String = "direct",
    val exitNode: String = "",
    val exitNodeLeakProtection: Boolean = true,
    val exitNodeActive: Boolean = false,
    val exitNodeBlocked: Boolean = false,
    val exitNodeStatusText: String = "",
    val exitDnsMode: String = "automatic",
    val exitDnsDohProvider: String = "cloudflare",
    val exitDnsCustomDohUrl: String = "",
    val exitDnsCustomDohBootstrapIps: String = "",
    val exitDnsThroughExitServers: String = "",
    ...
    val walletFiatEnabled: Boolean = true,
    val walletFiatCurrency: String = "USD",
    ...
    val fipsWebrtcEnabled: Boolean = false,
...
data class PaidExitSellerState(
    ...
    val currentConnectionCount: Long = 0,
    val pastConnectionCount: Long = 0,
    val totalBillableBytes: Long = 0,
    val totalTrafficText: String = "",
    val totalPaidMsat: Long = 0,
    val totalPaidText: String = "",
    val totalDueMsat: Long = 0,
    val totalDueText: String = "",
    val totalUnpaidMsat: Long = 0,
    val totalUnpaidText: String = "",
...
data class PaidRouteWalletState(
    ...
    val navigationBalanceText: String = "",
    val fiatCurrency: String = "",
    val fiatBalanceText: String = "",
    val exchangeRateText: String = "",
    val exchangeRateStatus: String = "",
    val exchangeRateSources: String = "",
    val exchangeRateStale: Boolean = false,
    val exchangeRateUpdatedAtUnix: Long = 0,
...
fun parseAppState(jsonText: String): AppState {
    ...
    return AppState(
        ...
        internetSource = json.optString("internetSource", "direct"),
        exitNode = json.optString("exitNode"),
        exitNodeLeakProtection = json.optBoolean("exitNodeLeakProtection", true),
        ...
        exitDnsMode = json.optString("exitDnsMode", "automatic"),
        exitDnsDohProvider = json.optString("exitDnsDohProvider", "cloudflare"),
        exitDnsCustomDohUrl = json.optString("exitDnsCustomDohUrl"),
        exitDnsCustomDohBootstrapIps = json.optString("exitDnsCustomDohBootstrapIps"),
        exitDnsThroughExitServers = json.optString("exitDnsThroughExitServers"),
        ...
        walletFiatEnabled = json.optBoolean("walletFiatEnabled", true),
        walletFiatCurrency = json.optString("walletFiatCurrency", "USD"),
        ...
        fipsWebrtcEnabled = json.optBoolean("fipsWebrtcEnabled", false),
...
private fun JSONObject?.toPaidExitSellerState(): PaidExitSellerState {
    ...
    return PaidExitSellerState(
        ...
        currentConnectionCount = optLong("currentConnectionCount"),
        pastConnectionCount = optLong("pastConnectionCount"),
        totalBillableBytes = optLong("totalBillableBytes"),
        totalTrafficText = optString("totalTrafficText"),
        totalPaidMsat = optLong("totalPaidMsat"),
        totalPaidText = optString("totalPaidText"),
        totalDueMsat = optLong("totalDueMsat"),
        totalDueText = optString("totalDueText"),
        totalUnpaidMsat = optLong("totalUnpaidMsat"),
        totalUnpaidText = optString("totalUnpaidText"),
...
private fun JSONObject?.toPaidRouteWalletState(): PaidRouteWalletState {
    ...
    return PaidRouteWalletState(
        ...
        navigationBalanceText = optString("navigationBalanceText"),
        fiatCurrency = optString("fiatCurrency"),
        fiatBalanceText = optString("fiatBalanceText"),
        exchangeRateText = optString("exchangeRateText"),
        exchangeRateStatus = optString("exchangeRateStatus"),
        exchangeRateSources = optString("exchangeRateSources"),
        exchangeRateStale = optBoolean("exchangeRateStale"),
        exchangeRateUpdatedAtUnix = optLong("exchangeRateUpdatedAtUnix"),
