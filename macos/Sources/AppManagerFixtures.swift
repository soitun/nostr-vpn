    ...
    static func screenshotFixtureState() -> NativeAppState {
        ...
        return NativeAppState(
            ...
            exitNodeStatusText: automaticExit
                ? "Automatic paid exit · FI · ≈ 0.02 USD/GB · 198.51.100.42 · Active"
            ...
            paidExitSeller: NativePaidExitSellerState(
                ...
                totalPaidText: "≈ 0.0736 USD paid",
                totalDueMsat: 88_000,
                totalDueText: "≈ 0.0704 USD due",
                totalUnpaidMsat: 0,
                totalUnpaidText: "",
                channels: [
                    NativePaidRouteChannelState(
                        ...
                        capacitySat: 250,
                        capacityText: "≈ 0.2 USD",
                        paidMsat: 35_000,
                        paidText: "≈ 0.028 USD paid",
                ...
                sessions: [
                    NativePaidRouteSessionState(
                        ...
                        detailText: "Paid, 11.4 MB used, ≈ 0.024 USD due",
            ...
            paidRouteMarket: NativePaidRouteMarketState(
                ...
                wallet: NativePaidRouteWalletState(
                    ...
                    totalBalanceText: "≈ 0.0984 USD",
                    channelBalanceMsat: 225_000,
                    channelBalanceText: "≈ 0.18 USD in channels",
                    navigationBalanceText: "≈ 0.0984 USD",
                    fiatCurrency: "USD",
                    fiatBalanceText: "≈ 0.0984 USD",
                ...
                lastPaymentAction: NativePaidRoutePaymentActionState(
                    ...
                    envelopeJson: "",
                    paidMsat: 0,
                    paidText: "≈ 0.00 USD paid",
                    deliveredUnits: 0,
                    deliveredUsageText: "0 units",
                    amountDueMsat: 0,
                    amountDueText: "≈ 0.00 USD due",
                    unpaidMsat: 0,
                    unpaidText: "",
                    allowRouting: false
                ),
                ...
                sessions: [
                    NativePaidRouteSessionState(
                        ...
                        amountDueText: "≈ 0.02 USD due",
                        paidMsat: 25_000,
                        paidText: "≈ 0.02 USD paid",
                        channelBalanceMsat: 225_000,
                        channelBalanceText: "≈ 0.18 USD in channel",
                        unpaidMsat: 0,
                        unpaidText: "",
                        activeMillis: 31_000,
                        bytes: 1_000_000_000,
