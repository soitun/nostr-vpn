...
func settingsPatch(
    ...
    exitDnsMode: String? = nil,
    exitDnsDohProvider: String? = nil,
    exitDnsCustomDohUrl: String? = nil,
    exitDnsCustomDohBootstrapIps: String? = nil,
    exitDnsThroughExitServers: String? = nil,
